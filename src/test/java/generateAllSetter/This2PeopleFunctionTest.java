 ...
 * @author stonex
 */
public class This2PeopleFunctionTest extends BaseTest {
    public void testConverter() throws IOException {
        String content=MiscUtils.readFileFromResource("testData/input/This2People.java");
        ...
        myFixture.checkResultByFile("output/This2People.java",true);
    }
}
