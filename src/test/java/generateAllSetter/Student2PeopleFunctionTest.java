 ...
 * @author stonex
 */
public class Student2PeopleFunctionTest extends BaseTest {
    public void testConverter() throws IOException {
        String content=MiscUtils.readFileFromResource("testData/input/Student2People.java");
        ...
        myFixture.checkResultByFile("output/Student2People.java",true);
    }
}
